// Create Schema — full-page editor matching the Entry editor layout
                    ...
                    <div className="bg-white rounded-2xl border border-surface-border shadow-sm p-8 transition-shadow hover:shadow-md duration-300">
                        ...
                        <div className="mb-6 pb-4 border-b border-surface-border">
                            ...
                            <p className="text-muted text-sm mt-1 mb-0">
                                Give your content type a name and a unique API identifier.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div className="mb-4 pt-4 pb-4 border-t border-b border-surface-border">
                                ...
                                <p className="text-muted text-sm mt-1 mb-0">
                                    Define the data structure for entries of this content type.
                                </p>
                            </div>
                ...
                <div className="lg:col-span-4 xl:col-span-3">
                    <div className="sticky top-32 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-surface-border shadow-sm p-6">
                            <h3 className="text-base font-semibold text-gray-800 mb-4 pb-3 border-b border-surface-border flex items-center gap-2">
                        ...
                        <div className="bg-white rounded-2xl border border-surface-border shadow-sm p-6">
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <span className="inline-flex items-center gap-1.5 text-sm font-medium text-amber-600 bg-amber-50 border border-amber-200 rounded-full px-2.5 py-0.5">
